...
import com.guidetourrefrence.AppTour;
import com.guidetourrefrence.MaterialSlide;
...
public class MainActivity extends AppTour {
    ...
    public void init(Bundle savedInstanceState) {
        ...
        Fragment firstSlide = MaterialSlide.newInstance(R.drawable.envofproject, "Presentations on the go",
                "Get stuff done with or without an internet connection.", Color.WHITE, Color.WHITE);

        Fragment secondSlide = MaterialSlide.newInstance(R.drawable.group, "Share and edit together",
                "Write on your own or invite more people to contribute.", Color.WHITE, Color.WHITE);

        Fragment thirdSlide = MaterialSlide.newInstance(R.drawable.envofproject, "Automatically save to the web",
                "Never lose your progress, so you can keep working from any computer or device.", Color.WHITE, Color.WHITE);

        Fragment forthSlide = MaterialSlide.newInstance(R.drawable.group, "Edit PowerPoint presentations",
